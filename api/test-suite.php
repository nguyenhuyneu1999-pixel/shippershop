...
// ============ API FILES EXIST ============
$apiFiles=['account.php','activity-feed.php','admin.php','admin-batch.php','admin-export.php','admin-notes.php','admin-users.php','analytics.php','announcements.php','badges.php','batch.php','bookmarks.php','calendar.php','chat-extras.php','content.php','content-queue.php','conv-labels.php','dashboard-summary.php','export.php','follow-suggest.php','friends.php','gamification.php','group-admin.php','group-chat.php','group-settings.php','groups.php','hashtags.php','health.php','heatmap.php','insights.php','link-preview.php','logs.php','marketplace.php','media.php','mentions.php','messages.php','moderation.php','msg-poll.php','mute.php','notif-grouped.php','notif-prefs.php','notifications.php','og-tags.php','payment.php','pins.php','polls.php','post-analytics.php','post-views.php','posts.php','preferences.php','presence.php','profile-card.php','profile-score.php','profile-theme.php','push.php','qr.php','reactions.php','recommend.php','referrals.php','report-analytics.php','reputation.php','scheduled.php','search.php','sitemap.php','social.php','sse.php','stats.php','status.php','stories.php','system-config.php','templates.php','traffic.php','trending.php','two-factor.php','upload-media.php','users.php','verification.php','wallet.php','webhooks.php','index.php'];
