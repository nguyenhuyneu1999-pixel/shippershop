...
// ============ API FILES EXIST ============
$apiFiles=['account.php','activity-feed.php','admin.php','admin-batch.php','admin-export.php','admin-notes.php','admin-stats-cache.php','admin-user-notes.php','admin-users.php','analytics.php','announcement-banner.php','announcements.php','badge-showcase.php','badges.php','batch.php','bookmarks.php','calendar.php','chat-extras.php','collections.php','content.php','content-filter.php','content-insights.php','content-queue.php','conv-archive.php','conv-labels.php','conv-pin.php','conv-search.php','dashboard-summary.php','events.php','export.php','feed-prefs.php','follow-suggest.php','friends.php','gamification.php','group-admin.php','group-chat.php','group-settings.php','groups.php','hashtags.php','health.php','health-alerts.php','heatmap.php','insights.php','link-preview.php','logs.php','marketplace.php','media.php','mentions.php','messages.php','milestones.php','moderation.php','msg-poll.php','mute.php','notif-grouped.php','notif-prefs.php','notifications.php','og-tags.php','outgoing-hooks.php','payment.php','perf.php','pins.php','polls.php','post-analytics.php','post-boost.php','post-polls.php','post-views.php','posts.php','preferences.php','presence.php','privacy.php','profile-card.php','profile-score.php','profile-theme.php','push.php','qr.php','rate-monitor.php','reactions.php','recommend.php','referrals.php','report-analytics.php','reputation.php','saved-collections.php','schedule-calendar.php','scheduled.php','search.php','share-to-group.php','site-config.php','sitemap.php','sitemap-gen.php','smart-suggest.php','social.php','sse.php','stats.php','status.php','stories.php','suggest.php','system-config.php','templates.php','traffic.php','trending.php','two-factor.php','upload-media.php','user-activity.php','users.php','verification.php','wallet.php','webhooks.php','index.php'];
