...
// ============ API FILES EXIST ============
$apiFiles=['ab-optimizer.php','ab-split.php','ab-test.php','account.php','achievements.php','achievements-wall.php','activity-feed.php','activity-heatmap.php','admin.php','admin-audit.php','admin-audit-v2.php','admin-backup.php','admin-batch.php','admin-content-quality.php','admin-content-schedule.php','admin-dashboard-v2.php','admin-export.php','admin-ip.php','admin-kpi.php','admin-notes.php','admin-overview.php','admin-revenue.php','admin-stats-cache.php','admin-summary.php','admin-table-stats.php','admin-timeline.php','admin-user-notes.php','admin-users.php','admin-widgets.php','ai-suggest.php','analytics.php','analytics-export.php','announce-schedule.php','announcement-banner.php','announcements.php','api-performance.php','api-usage.php','area-coverage.php','audience-insights.php','auto-tag.php','badge-showcase.php','badges.php','badges-wall.php','ban-appeals.php','bandwidth-monitor.php','batch.php','bookmarks.php','break-timer.php','calendar.php','calendar-v2.php','calendar-view.php','chat-extras.php','checkin.php','churn-predict.php','cod-tracker.php','cohort-analysis.php','collections.php','contact-card.php','content.php','content-analyzer.php','content-benchmark.php','content-calendar.php','content-calendar-v2.php','content-compare.php','content-filter.php','content-insights.php','content-insights-ai.php','content-moderate.php','content-pipeline.php','content-queue.php','content-recycler.php','content-rewriter.php','content-score.php','content-summary.php','content-warnings.php','conv-archive.php','conv-auto-archive.php','conv-auto-label.php','conv-bookmarks.php','conv-checklist.php','conv-countdown.php','conv-delivery-eta.php','conv-delivery-handoff.php','conv-delivery-map.php','conv-delivery-schedule.php','conv-delivery-summary.php','conv-expense-log.php','conv-export.php','conv-files.php','conv-fuel-split.php','conv-group-delivery.php','conv-incident-report.php','conv-labels.php','conv-location.php','conv-location-live.php','conv-media.php','conv-media-gallery.php','conv-meeting.php','conv-notes.php','conv-order-board.php','conv-payment-split.php','conv-pin.php','conv-pinned-topics.php','conv-polls.php','conv-quick-actions.php','conv-quick-polls.php','conv-reactions-summary.php','conv-read-status.php','conv-receipt-share.php','conv-reminder.php','conv-reminders.php','conv-schedule.php','conv-search.php','conv-shared-notes.php','conv-shift-swap.php','conv-status-update.php','conv-stickers.php','conv-summary.php','conv-tags.php','conv-task-assign.php','conv-templates.php','conv-threads.php','conv-voice-memo.php','conv-weather-share.php','conversion-tracker.php','cron-monitor.php','customer-contacts.php','daily-digest.php','daily-earnings.php','daily-planner.php','daily-report.php','dashboard-summary.php','db-health.php','delivery-analytics.php','delivery-checklist.php','delivery-map.php','delivery-notes.php','delivery-proof.php','delivery-rating.php','delivery-receipt.php','delivery-stats.php','delivery-stats-v2.php','delivery-zones.php','disappearing-msgs.php','draft-collab.php','drafts-manager.php','drafts-sync.php','earnings-calc.php','engagement-compare.php','engagement-dashboard.php','engagement-funnel.php','engagement-heatmap.php','engagement-predict.php','engagement-score.php','engagement-score-v2.php','error-tracker.php','events.php','expense-report.php','expense-splitter.php','export.php','faq.php','feature-flags.php','feed-prefs.php','feedback.php','fleet-manager.php','follow-requests.php','follow-suggest.php','fraud-detection.php','friends.php','fuel-tracker.php','gamification.php','group-admin.php','group-chat.php','group-settings.php','groups.php','growth-funnel.php','growth-metrics.php','hashtag-analytics.php','hashtag-generator.php','hashtags.php','health.php','health-alerts.php','health-score.php','heatmap.php','income-goal.php','income-tracker.php','insights.php','insights-v2.php','kpi-dashboard.php','leaderboard-seasons.php','link-preview.php','login-monitor.php','logs.php','maintenance.php','marketplace.php','media.php','mentions.php','messages.php','mileage-log.php','milestones.php','mod-queue.php','moderation.php','msg-forward.php','msg-poll.php','msg-reactions.php','mute.php','notif-analytics.php','notif-blast.php','notif-grouped.php','notif-prefs.php','notifications.php','og-tags.php','online-privacy.php','order-tracker.php','outgoing-hooks.php','page-speed.php','parking-finder.php','payment.php','perf.php','pins.php','plagiarism-check.php','plagiarism-v2.php','platform-alerts.php','platform-century.php','platform-health-v2.php','platform-scorecard.php','platform-stats.php','polls.php','post-analytics.php','post-analytics-v2.php','post-best-time.php','post-bookmarks-folder.php','post-boost.php','post-collab.php','post-collections.php','post-digest.php','post-engagement-predict.php','post-expiry.php','post-highlights.php','post-performance.php','post-polls.php','post-reach.php','post-schedule-v2.php','post-sentiment.php','post-share-stats.php','post-similar.php','post-stats-detail.php','post-version-history.php','post-views.php','post-word-cloud.php','posts.php','predict-v2.php','preferences.php','presence.php','privacy.php','profile-card.php','profile-score.php','profile-theme.php','profile-themes.php','push.php','qr.php','quality-gate.php','queue-dashboard.php','rate-monitor.php','rating-history.php','reactions.php','reactions-analytics.php','read-later.php','realtime-monitor.php','recommend.php','referral-dashboard.php','referrals.php','report-analytics.php','report-generator.php','reputation.php','reputation-tiers.php','retention-dashboard.php','retention-score.php','revenue-forecast.php','revenue-tracker.php','route-history.php','route-optimizer.php','route-planner.php','safety-sos.php','saved-collections.php','saved-replies.php','schedule-calendar.php','schedule-queue.php','schedule-templates.php','schedule-v3.php','scheduled.php','scheduler-v2.php','search.php','search-history.php','sentiment-timeline.php','sentiment-v2.php','seo-monitor.php','share-to-group.php','shift-logger.php','shift-planner.php','shipper-map.php','shipper-passport.php','shipper-profile-v2.php','short-link.php','site-config.php','sitemap.php','sitemap-gen.php','skill-tags.php','smart-reply.php','smart-schedule.php','smart-suggest.php','social.php','sse.php','starred-msgs.php','stats.php','status.php','stories.php','suggest.php','system-alerts.php','system-config.php','system-health.php','template-library.php','template-market.php','templates.php','timeline.php','tip-calculator.php','tip-jar.php','traffic.php','trend-detector.php','trending.php','trending-topics.php','trending-v2.php','two-factor.php','typing-stats.php','upload-media.php','user-activity.php','user-availability.php','user-compare.php','user-connections.php','user-dashboard.php','user-funnel.php','user-goals.php','user-lifecycle.php','user-lifecycle-v2.php','user-notes.php','user-portfolio.php','user-prefs.php','user-ratings.php','user-segment-v2.php','user-segment-v3.php','user-segments.php','user-summary-card.php','user-theme.php','users.php','vehicle-inspection.php','vehicle-manager.php','verification.php','viral-detector.php','voice-notes.php','voice-transcribe.php','wallet.php','wallet-chart.php','weather-alerts.php','weather-radar.php','webhook-logs.php','webhook-manager.php','webhooks.php','weekly-challenge.php','weekly-report.php','work-history.php','index.php'];
...
// Delivery rating (auth)
$dr3Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$dr3Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/delivery-rating.php?user_id=3',$dr3Ctx),true);
t('Func: delivery rating endpoint',$dr3Resp!==null);

// Post engagement predict
$pepResp=json_decode(http_get('https://shippershop.vn/api/v2/post-engagement-predict.php?text='.urlencode('shipper giao hang nhanh quan 7 #shipper').'&has_image=1&hour=20'),true);
t('Func: engagement predict',$pepResp&&$pepResp['success']===true&&$pepResp['data']['predicted_likes']>=0);
t('Func: predict factors',count($pepResp['data']['factors'] ?? [])>=1);
t('Func: predict confidence',$pepResp['data']['confidence']>=50);

// Admin content quality (admin)
$acqCtx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$acqResp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/admin-content-quality.php',$acqCtx),true);
t('Func: admin content quality',$acqResp!==null);

// Conv expense log (auth)
$celCtx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$celResp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/conv-expense-log.php?conversation_id=1',$celCtx),true);
t('Func: conv expense log',$celResp!==null);


// Delivery checklist (auth)
$dclCtx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$dclResp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/delivery-checklist.php',$dclCtx),true);
t('Func: delivery checklist endpoint',$dclResp!==null);

// Schedule v3 (auth)
$sv3Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$sv3Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/schedule-v3.php',$sv3Ctx),true);
t('Func: schedule v3 endpoint',$sv3Resp!==null);

// Fraud detection (admin)
$fd2Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$fd2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/fraud-detection.php',$fd2Ctx),true);
t('Func: fraud detection endpoint',$fd2Resp!==null);

// Conv voice memo (auth)
$cvmCtx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$cvmResp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/conv-voice-memo.php?conversation_id=1',$cvmCtx),true);
t('Func: conv voice memo endpoint',$cvmResp!==null);


// Safety SOS (auth)
$sosCtx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$sosResp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/safety-sos.php',$sosCtx),true);
t('Func: safety SOS endpoint',$sosResp!==null);

// Content calendar v2 (auth)
$ccv2Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$ccv2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/content-calendar-v2.php',$ccv2Ctx),true);
t('Func: content calendar v2',$ccv2Resp!==null);

// Webhook manager (admin)
$wm2Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$wm2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/webhook-manager.php',$wm2Ctx),true);
t('Func: webhook manager endpoint',$wm2Resp!==null);

// Conv receipt share (auth)
$crsCtx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$crsResp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/conv-receipt-share.php?conversation_id=1',$crsCtx),true);
t('Func: conv receipt share',$crsResp!==null);


// Vehicle inspection (auth)
$vi2Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$vi2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/vehicle-inspection.php',$vi2Ctx),true);
t('Func: vehicle inspection endpoint',$vi2Resp!==null);

// AB optimizer (auth)
$aboCtx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$aboResp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/ab-optimizer.php',$aboCtx),true);
t('Func: ab optimizer endpoint',$aboResp!==null);

// Platform health v2 (admin)
$phv2Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$phv2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/platform-health-v2.php',$phv2Ctx),true);
t('Func: platform health v2',$phv2Resp!==null);

// Conv delivery handoff (auth)
$cdhCtx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$cdhResp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/conv-delivery-handoff.php?conversation_id=1',$cdhCtx),true);
t('Func: conv delivery handoff',$cdhResp!==null);


// SESSION 100 — Shipper Passport (auth)
$sp2Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$sp2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/shipper-passport.php',$sp2Ctx),true);
t('S100: shipper passport endpoint',$sp2Resp!==null);

// Platform Century (public)
$pcResp=json_decode(http_get('https://shippershop.vn/api/v2/platform-century.php'),true);
t('S100: platform century',$pcResp&&$pcResp['success']===true&&isset($pcResp['data']['community']));
t('S100: century session 100',$pcResp['data']['session']===100);
t('S100: century version v10',$pcResp['data']['version']==='v10.0.0');
t('S100: century community users',$pcResp['data']['community']['users']>=100);

// Admin audit v2 (admin)
$aav2Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$aav2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/admin-audit-v2.php',$aav2Ctx),true);
t('S100: admin audit v2',$aav2Resp!==null);

// Conv delivery summary (auth)
$cdsmCtx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$cdsmResp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/conv-delivery-summary.php?conversation_id=1',$cdsmCtx),true);
t('S100: conv delivery summary',$cdsmResp!==null);


// Daily earnings (auth)
$de2Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$de2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/daily-earnings.php',$de2Ctx),true);
t('Func: daily earnings endpoint',$de2Resp!==null);
...
$ulv2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/user-lifecycle-v2.php',$ulv2Ctx),true);
t('Func: user lifecycle v2',$ulv2Resp!==null);

// Conv group delivery (auth)
$cgdCtx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$cgdResp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/conv-group-delivery.php?conversation_id=1',$cgdCtx),true);
t('Func: conv group delivery',$cgdResp!==null);


// Route history (auth)
$rh2Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$rh2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/route-history.php',$rh2Ctx),true);
t('Func: route history endpoint',$rh2Resp!==null);

// Content recycler (auth)
$cr3Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$cr3Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/content-recycler.php',$cr3Ctx),true);
t('Func: content recycler endpoint',$cr3Resp!==null);

// Engagement funnel (admin)
$ef2Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$ef2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/engagement-funnel.php?days=30',$ef2Ctx),true);
t('Func: engagement funnel endpoint',$ef2Resp!==null);

// Conv shift swap (auth)
$css2Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$css2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/conv-shift-swap.php?conversation_id=1',$css2Ctx),true);
t('Func: conv shift swap endpoint',$css2Resp!==null);

// Sentiment negative test
$sv2Neg=json_decode(http_get('https://shippershop.vn/api/v2/sentiment-v2.php?text='.urlencode('buon chan qua giao hang met moi stress')),true);
t('Cross: sentiment negative',$sv2Neg&&$sv2Neg['data']['sentiment']==='negative');

// Platform century session check
$pcCheck=json_decode(http_get('https://shippershop.vn/api/v2/platform-century.php'),true);
t('Cross: century community posts',$pcCheck['data']['community']['posts'] ?? 0 > 0);

// Content calendar current month
$ccv2CurCtx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$ccv2CurResp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/content-calendar-v2.php',$ccv2CurCtx),true);
t('Cross: content calendar auth',$ccv2CurResp!==null);

// Quality gate long text
$qgLong=json_decode(http_get('https://shippershop.vn/api/v2/quality-gate.php?text='.urlencode('Day la mot bai viet dai hon 80 ky tu de kiem tra chat luong noi dung tren he thong shippershop viet nam #shipper #giaohang').'&has_image=1'),true);
t('Cross: quality gate A grade',$qgLong&&$qgLong['data']['grade']==='A');


// Parking finder (auth)
$pf2Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$pf2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/parking-finder.php',$pf2Ctx),true);
t('Func: parking finder endpoint',$pf2Resp!==null);

// Post version history (auth)
$pvhCtx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$pvhResp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/post-version-history.php?post_id=1038',$pvhCtx),true);
t('Func: post version history',$pvhResp!==null);

// API performance (admin)
$apdCtx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$apdResp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/api-performance.php',$apdCtx),true);
t('Func: api performance',$apdResp!==null);

// Conv delivery ETA (auth)
$cdeCtx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$cdeResp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/conv-delivery-eta.php?conversation_id=1',$cdeCtx),true);
t('Func: conv delivery eta',$cdeResp!==null);

// Engagement predict with no image
$pepNoImg=json_decode(http_get('https://shippershop.vn/api/v2/post-engagement-predict.php?text='.urlencode('shipper giao hang').'&hour=3'),true);
t('Cross: predict low hour',($pepNoImg['data']['predicted_likes'] ?? -1)>=0);

// Route history auth check
$rh3Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$rh3Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/route-history.php',$rh3Ctx),true);
t('Cross: route history auth',$rh3Resp!==null);


// Weather radar (auth)
$wr2Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$wr2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/weather-radar.php',$wr2Ctx),true);
t('Func: weather radar endpoint',$wr2Resp!==null);

// Weather radar conditions
$wrCond=json_decode(http_get_ctx('https://shippershop.vn/api/v2/weather-radar.php?action=conditions',$wr2Ctx),true);
t('Func: weather conditions 8',$wrCond!==null);

// Draft collab (auth)
$dc2Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$dc2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/draft-collab.php',$dc2Ctx),true);
t('Func: draft collab endpoint',$dc2Resp!==null);

// User segment v3 (admin)
$usv3Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$usv3Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/user-segment-v3.php',$usv3Ctx),true);
t('Func: user segment v3',$usv3Resp!==null);

// Conv fuel split (auth)
$cfs2Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$cfs2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/conv-fuel-split.php?conversation_id=1',$cfs2Ctx),true);
t('Func: conv fuel split',$cfs2Resp!==null);


// Break timer (auth)
$bt2Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$bt2Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/break-timer.php',$bt2Ctx),true);
t('Func: break timer endpoint',$bt2Resp!==null);

// Hashtag generator
$hgResp=json_decode(http_get('https://shippershop.vn/api/v2/hashtag-generator.php?text='.urlencode('shipper giao hang tphcm ghtk nhanh')),true);
t('Func: hashtag generator',$hgResp&&$hgResp['success']===true&&count($hgResp['data']['hashtags'] ?? [])>=3);
t('Func: hashtag shipper tag',in_array('#shipper',$hgResp['data']['hashtags'] ?? [])||in_array('#giaohang',$hgResp['data']['hashtags'] ?? []));

// Hashtag trending fallback
$hgEmpty=json_decode(http_get('https://shippershop.vn/api/v2/hashtag-generator.php'),true);
t('Func: hashtag trending fallback',$hgEmpty&&($hgEmpty['data']['source'] ?? '')==='trending');

// Conversion tracker (admin)
$ct3Ctx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$ct3Resp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/conversion-tracker.php?days=30',$ct3Ctx),true);
t('Func: conversion tracker endpoint',$ct3Resp!==null);

// Conv incident report (auth)
$cirCtx=stream_context_create(['http'=>['ignore_errors'=>true,'timeout'=>10]]);
$cirResp=json_decode(http_get_ctx('https://shippershop.vn/api/v2/conv-incident-report.php?conversation_id=1',$cirCtx),true);
t('Func: conv incident report',$cirResp!==null);
