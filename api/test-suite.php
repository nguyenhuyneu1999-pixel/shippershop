...
// ============ API FILES EXIST ============
$apiFiles=['posts.php','messages.php','users.php','notifications.php','search.php','admin.php','wallet.php','traffic.php','marketplace.php','analytics.php','health.php','groups.php','gamification.php','social.php','content.php','push.php','referrals.php','stats.php','status.php','hashtags.php','friends.php','stories.php','bookmarks.php','index.php'];
