...
// ============ API FILES EXIST ============
$apiFiles=['account.php','achievements.php','achievements-wall.php','activity-feed.php','activity-heatmap.php','admin.php','admin-backup.php','admin-batch.php','admin-content-schedule.php','admin-dashboard-v2.php','admin-export.php','admin-ip.php','admin-notes.php','admin-revenue.php','admin-stats-cache.php','admin-timeline.php','admin-user-notes.php','admin-users.php','admin-widgets.php','analytics.php','analytics-export.php','announce-schedule.php','announcement-banner.php','announcements.php','auto-tag.php','badge-showcase.php','badges.php','badges-wall.php','ban-appeals.php','batch.php','bookmarks.php','calendar.php','chat-extras.php','checkin.php','collections.php','content.php','content-calendar.php','content-filter.php','content-insights.php','content-queue.php','content-summary.php','conv-archive.php','conv-export.php','conv-labels.php','conv-notes.php','conv-pin.php','conv-quick-actions.php','conv-read-status.php','conv-reminders.php','conv-search.php','conv-tags.php','conv-threads.php','daily-digest.php','dashboard-summary.php','delivery-stats.php','drafts-manager.php','engagement-predict.php','engagement-score.php','events.php','export.php','faq.php','feed-prefs.php','feedback.php','follow-requests.php','follow-suggest.php','friends.php','gamification.php','group-admin.php','group-chat.php','group-settings.php','groups.php','hashtags.php','health.php','health-alerts.php','heatmap.php','insights.php','link-preview.php','logs.php','maintenance.php','marketplace.php','media.php','mentions.php','messages.php','milestones.php','moderation.php','msg-forward.php','msg-poll.php','msg-reactions.php','mute.php','notif-blast.php','notif-grouped.php','notif-prefs.php','notifications.php','og-tags.php','online-privacy.php','outgoing-hooks.php','payment.php','perf.php','pins.php','platform-stats.php','polls.php','post-analytics.php','post-boost.php','post-collections.php','post-digest.php','post-expiry.php','post-polls.php','post-schedule-v2.php','post-sentiment.php','post-share-stats.php','post-stats-detail.php','post-views.php','posts.php','preferences.php','presence.php','privacy.php','profile-card.php','profile-score.php','profile-theme.php','profile-themes.php','push.php','qr.php','queue-dashboard.php','rate-monitor.php','reactions.php','read-later.php','recommend.php','referral-dashboard.php','referrals.php','report-analytics.php','reputation.php','reputation-tiers.php','saved-collections.php','saved-replies.php','schedule-calendar.php','schedule-templates.php','scheduled.php','search.php','search-history.php','share-to-group.php','shipper-map.php','short-link.php','site-config.php','sitemap.php','sitemap-gen.php','skill-tags.php','smart-suggest.php','social.php','sse.php','starred-msgs.php','stats.php','status.php','stories.php','suggest.php','system-config.php','system-health.php','template-market.php','templates.php','timeline.php','traffic.php','trending.php','trending-topics.php','two-factor.php','typing-stats.php','upload-media.php','user-activity.php','user-compare.php','user-connections.php','user-notes.php','user-portfolio.php','user-prefs.php','user-segments.php','user-theme.php','users.php','verification.php','wallet.php','webhooks.php','weekly-report.php','index.php'];
