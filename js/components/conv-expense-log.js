...
SS.ConvExpenseLog = {
  show: function(arg) {
    var url = '/conv-expense-log.php' + (arg ? (typeof arg === 'number' ? '?conversation_id=' + arg + '&user_id=' + arg : '?text=' + encodeURIComponent(arg)) : '');
    SS.api.get(url).then(function(d) {
      ...
      SS.ui.sheet({title: 'ConvExpenseLog', html: html});
    });
  }
};
