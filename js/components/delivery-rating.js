...
SS.DeliveryRating = {
  show: function(arg) {
    var url = '/delivery-rating.php' + (arg ? (typeof arg === 'number' ? '?conversation_id=' + arg + '&user_id=' + arg : '?text=' + encodeURIComponent(arg)) : '');
    SS.api.get(url).then(function(d) {
      ...
      SS.ui.sheet({title: 'DeliveryRating', html: html});
    });
  }
};
